/* uLisp AVR Version 3.5 for the Pocket Op Amp Lab - see http://www.ulisp.com/show?3I99
   David Johnson-Davies - www.technoblogy.com - 9th March 2021
...
PGM_P const streamname[] PROGMEM = {serialstream, i2cstream, spistream, sdstream, gfxstream};
...
#if defined(CPU_ATmega328P) || defined(CPU_ATmega2560) || defined(CPU_ATmega1284P) || defined(CPU_AVR128DX28) || defined(CPU_AVR128DX48)
...
FORMILLIS, WITHSERIAL, WITHI2C, WITHSPI, WITHSDCARD, WITHGFX, TAIL_FORMS, PROGN, IF, COND, WHEN, UNLESS,
...
EDIT, PPRINT, PPRINTALL, FORMAT, REQUIRE, LISTLIBRARY, DRAWPIXEL, DRAWLINE, DRAWRECT, FILLRECT,
...
#elif defined(CPU_AVR128DX28) || defined(CPU_AVR128DX48)
...
#if defined(CPU_ATmega4809) || defined(CPU_AVR128DX28) || defined(CPU_AVR128DX48)
...
#if defined(CPU_ATmega1284P) || defined(CPU_AVR128DX28)
...
void serialbegin (int address, int baud) {
  ...
  #elif defined(CPU_ATmega1284P) || defined(CPU_AVR128DX28)
...
object *fn_analogreadresolution (object *args, object *env) {
  (void) env;
  object *arg = first(args);
  #if defined(CPU_AVR128DX28) || defined(CPU_AVR128DX48)
...
object *fn_dacreference (object *args, object *env) {
  ...
  object *arg = first(args);
  #if defined(CPU_AVR128DX28) || defined(CPU_AVR128DX48)
  int ref = checkkeyword(ANALOGREFERENCE, arg);
  Serial.print(ref);
  DACReference(ref);
  #endif
  return arg;
...
const char string31[] PROGMEM = "with-gfx";
...
const char string167[] PROGMEM = "draw-pixel";
const char string168[] PROGMEM = "draw-line";
const char string169[] PROGMEM = "draw-rect";
const char string170[] PROGMEM = "fill-rect";
const char string171[] PROGMEM = "draw-circle";
const char string172[] PROGMEM = "fill-circle";
const char string173[] PROGMEM = "draw-round-rect";
const char string174[] PROGMEM = "fill-round-rect";
const char string175[] PROGMEM = "draw-triangle";
const char string176[] PROGMEM = "fill-triangle";
const char string177[] PROGMEM = "draw-char";
const char string178[] PROGMEM = "set-cursor";
const char string179[] PROGMEM = "set-text-color";
const char string180[] PROGMEM = "set-text-size";
const char string181[] PROGMEM = "set-text-wrap";
const char string182[] PROGMEM = "fill-screen";
const char string183[] PROGMEM = "set-rotation";
const char string184[] PROGMEM = "invert-display";
...
const char string192[] PROGMEM = ":internal";
...
const char string191[] PROGMEM = ":default";
const char string192[] PROGMEM = ":internal";
const char string193[] PROGMEM = ":vdd";
const char string194[] PROGMEM = ":internal0v55";
const char string195[] PROGMEM = ":internal1v1";
const char string196[] PROGMEM = ":internal1v5";
const char string197[] PROGMEM = ":internal2v5";
const char string198[] PROGMEM = ":internal4v3";
const char string199[] PROGMEM = ":external";
const char string200[] PROGMEM = "";
#elif defined(CPU_AVR128DX28) || defined(CPU_AVR128DX48)
const char string186[] PROGMEM = ":high";
const char string187[] PROGMEM = ":low";
const char string188[] PROGMEM = ":input";
...
const tbl_entry_t lookup_table[] PROGMEM = {
  ...
  { string167, fn_drawpixel, 0x23 },
  { string168, fn_drawline, 0x45 },
  { string169, fn_drawrect, 0x45 },
  { string170, fn_fillrect, 0x45 },
  { string171, fn_drawcircle, 0x34 },
  { string172, fn_fillcircle, 0x34 },
  { string173, fn_drawroundrect, 0x56 },
  { string174, fn_fillroundrect, 0x56 },
  { string175, fn_drawtriangle, 0x67 },
  { string176, fn_filltriangle, 0x67 },
  { string177, fn_drawchar, 0x36 },
  { string178, fn_setcursor, 0x22 },
  { string179, fn_settextcolor, 0x12 },
  { string180, fn_settextsize, 0x11 },
  { string181, fn_settextwrap, 0x11 },
  { string182, fn_fillscreen, 0x01 },
  { string183, fn_setrotation, 0x11 },
  { string184, fn_invertdisplay, 0x11 },
  { string185, NULL, 0x00 },
#if defined(CPU_ATmega328P)
  { string186, (fn_ptr_type)HIGH, DIGITALWRITE },
  { string187, (fn_ptr_type)LOW, DIGITALWRITE },
  { string188, (fn_ptr_type)INPUT, PINMODE },
  { string189, (fn_ptr_type)INPUT_PULLUP, PINMODE },
  { string190, (fn_ptr_type)OUTPUT, PINMODE },
  { string191, (fn_ptr_type)DEFAULT, ANALOGREFERENCE },
  { string192, (fn_ptr_type)INTERNAL, ANALOGREFERENCE },
  { string193, (fn_ptr_type)EXTERNAL, ANALOGREFERENCE },
  { string194, NULL, 0x00 },
#elif defined(CPU_ATmega2560)
  { string186, (fn_ptr_type)HIGH, DIGITALWRITE },
  { string187, (fn_ptr_type)LOW, DIGITALWRITE },
  ...
  { string190, (fn_ptr_type)OUTPUT, PINMODE },
  { string191, (fn_ptr_type)DEFAULT, ANALOGREFERENCE },
  { string192, (fn_ptr_type)INTERNAL1V1, ANALOGREFERENCE },
  { string193, (fn_ptr_type)INTERNAL2V56, ANALOGREFERENCE },
  { string194, (fn_ptr_type)EXTERNAL, ANALOGREFERENCE },
  { string195, NULL, 0x00 },
#elif defined(CPU_ATmega4809)
  { string186, (fn_ptr_type)HIGH, DIGITALWRITE },
  { string187, (fn_ptr_type)LOW, DIGITALWRITE },
  ...
  { string191, (fn_ptr_type)DEFAULT, ANALOGREFERENCE },
  { string192, (fn_ptr_type)INTERNAL, ANALOGREFERENCE },
  { string193, (fn_ptr_type)VDD, ANALOGREFERENCE },
  { string194, (fn_ptr_type)INTERNAL0V55, ANALOGREFERENCE },
  { string195, (fn_ptr_type)INTERNAL1V1, ANALOGREFERENCE },
  { string196, (fn_ptr_type)INTERNAL1V5, ANALOGREFERENCE },
  { string197, (fn_ptr_type)INTERNAL2V5, ANALOGREFERENCE },
  { string198, (fn_ptr_type)INTERNAL4V3, ANALOGREFERENCE },
  { string199, (fn_ptr_type)EXTERNAL, ANALOGREFERENCE },
  { string200, NULL, 0x00 },
#elif defined(CPU_AVR128DX28) || defined(CPU_AVR128DX48)
  { string186, (fn_ptr_type)HIGH, DIGITALWRITE },
  { string187, (fn_ptr_type)LOW, DIGITALWRITE },
  ...
  { string190, (fn_ptr_type)OUTPUT, PINMODE },
  { string191, (fn_ptr_type)DEFAULT, ANALOGREFERENCE },
  { string192, (fn_ptr_type)VDD, ANALOGREFERENCE },
  { string193, (fn_ptr_type)INTERNAL1V024, ANALOGREFERENCE },
  { string194, (fn_ptr_type)INTERNAL2V048, ANALOGREFERENCE },
  { string195, (fn_ptr_type)INTERNAL4V096, ANALOGREFERENCE },
  { string196, (fn_ptr_type)INTERNAL2V5, ANALOGREFERENCE },
  { string197, (fn_ptr_type)EXTERNAL, ANALOGREFERENCE },
  { string198, (fn_ptr_type)ADC_DAC0, ANALOGREAD },
  { string199, (fn_ptr_type)ADC_TEMPERATURE, ANALOGREAD },
  { string200, NULL, 0x00 },
#endif
